...
% KWC Modified on 210402 from http://www.tedpavlic.com/TPCV.php
%%%%%%%%%%%%%%%%%%%%%%%%% Document Setup %%%%%%%%%%%%%%%%%%%%%%%%%%
...
%\rhead{Cooper ~\arabic{page} of \protect\pageref*{LastPage}}   % +LP
...
\renewcommand{\@evenfoot}{\hspace*{-\footpageshift}\hfil %
   Page~\arabic{page} of \protect\pageref*{LastPage} |  \textit{Last updated \today} % +LP
%    p.~\arabic{page}                               % -LP
    \hfil }%
...
Ph.D., Neuroscience \hfill est. 2023
...
\begin{bibenum}
    \item Cooper K. W. (2019) Cholinergic modulation may explain hippocampal encoding and retrieval mode switching. Indiana University, Bloomington. 
...
\begin{tabular*}{\textwidth}{ l @{\extracolsep{\fill}}  l @{}}
	AskANeuroscientist & \textit{Founder; K-12 class Q/A (reached >500 students)} \\

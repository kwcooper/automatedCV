...
\newcommand{\orcid}{\includegraphics[width=10pt]{cooperCV_v1/img/orcid.png}} % cutom for orcidID
...
% Heading. Use a period now to trick Hfill... maybe use a table or something else? 
\hspace*{-\marginparsep minus \marginparwidth}%
 \begin{minipage}[t]{\textwidth+\marginparwidth+\marginparsep}%
...
%\makeheading[]{Keiland W. Cooper} % NAME
...
%\parbox{\rcollength}{%
%\emph{\faEnvelope} \email{kwcooper@uci.edu}\\
%\emph{\faHome} \href{http://www.kwcooper.com/}{www.kwcooper.com}}
%
%\end{tabular}
...
\rule{\columnwidth}{1pt}\\
\section{Selected Abstracts and Talks}
...
%\begin{tabular}{l l l}
\begin{tabular*}{\textwidth}{@{} l l l@{\extracolsep{\fill}}  r @{}}
	Autonomous Robotics & Co-instructor & \textit{Indiana University} &  2019 \\
	Programming in Cognitive Sciences & Co-instructor & \textit{Indiana University} & 2018 \\
...
\vspace{1\baselineskip}
\rule{\columnwidth}{1pt}\\
\section{Selected Outreach + Service}

%\begin{tabular}{l l l}
\begin{tabular*}{\textwidth}{ l @{\extracolsep{\fill}}  l @{}}
	AskANeuroscientist & \textit{Founder; K-12 class Q/A (reached >400 students)} \\
	Hoosier STARS & \textit{Co-founder; K-12 class neuro demos (reached >300 students)} \\
	CNLM Ambassadors & \textit{Co-chair; SoCal Learning and memory outreach} \\
	UCI End Racism  & \textit{Working group contributer addressing systemic racism}\\	
	Quora Writer & \textit{Answers to neuroscience and AI questions; 800k+ views} \\
	Peer reviewer& \textit{Physiological Reviews; CVPR} \\

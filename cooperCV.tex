...
\mytl{2016-2019}{with Dr. Ehren Newman | \textcolor{gray}{Neuroscience}  \\- \textit{Computational modeling of ACh + brain oscilations}  \\- \textit{Entorhinal region electrophysiology}  \\- \textit{Hippocampal imaging with Miniscopes}  \\- \textit{Theta + optic flow rodent behavior} }
...
\begin{etaremune}[itemindent=-1.5\bibhang, topsep=0pt,
    ...
    \item Deep neural network models learn distinguishable features from hippocampal local field potential and ensemble data\\ Pan, C. J., Cooper, K. W., Li, L., Agostinelli, F., Saraf, M., Elias, G. A., Baldi, P.,  Shahbaba, B., Fortin, N. J.. (2021) UROP. 
